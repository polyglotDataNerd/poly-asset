...
func (_Token *TokenCaller) Uri(opts *bind.CallOpts, id *big.Int) (string, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "uri", id)
...
//
// Solidity: function uri(uint256 id) view returns(string)
func (_Token *TokenSession) Uri(id *big.Int) (string, error) {
	return _Token.Contract.Uri(&_Token.CallOpts, id)
}

// Uri is a free data retrieval call binding the contract method 0x0e89341c.
//
// Solidity: function uri(uint256 id) view returns(string)
func (_Token *TokenCallerSession) Uri(id *big.Int) (string, error) {
	return _Token.Contract.Uri(&_Token.CallOpts, id)
}
